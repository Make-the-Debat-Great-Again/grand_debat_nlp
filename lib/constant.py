...
question_patterns = {
    "transition_eco":{
        ...
        "QUXVlc3Rpb246MTU5 - Y a-t-il d'autres points sur la transition écologique sur lesquels vous souhaiteriez vous exprimer ?": [1, 2, 3]
    },
    "fiscalite_et_depense":{
        ...
        "QUXVlc3Rpb246MTY0 - Quels sont selon vous les impôts qu'il faut baisser en priorité ?":[2],
        "QUXVlc3Rpb246MjA2 - Afin de financer les dépenses sociales, faut-il selon vous...":[2],
        "QUXVlc3Rpb246MjA1 - S'il faut selon vous revoir les conditions d'attribution de certaines aides sociales, lesquelles doivent être concernées ?":[1],
        "QUXVlc3Rpb246MTY1 - Quels sont les domaines prioritaires où notre protection sociale doit être renforcée ?":[1],
    ...
    ,"demo_et_citoy":{
        "QUXVlc3Rpb246MTA3 - En qui faites-vous le plus confiance pour vous faire représenter dans la société et pourquoi ?":[1],
        ...
        "QUXVlc3Rpb246MTEx - Le non-cumul des mandats instauré en 2017 pour les parlementaires (députés et sénateurs) est :":[5],
        ...
        "QUXVlc3Rpb246MTE1 - Si oui, lesquels ?":[2],
        ...
        "QUXVlc3Rpb246MTM5 - Si oui, lesquelles ?":[1],
    ...
    "org_etat_et_services_publics":{
        ...
        "QUXVlc3Rpb246MTc0 - Quels nouveaux services ou quelles démarches souhaitez-vous voir développées sur Internet en priorité ?":[5],
        ...
        "QUXVlc3Rpb246MTc5 - Quels sont les services publics qui doivent le plus évoluer selon vous ?":[5],
        ...
        "l'administration concernée :":[1,3],
        ...
        "point, l'administration concernée :":[1,3],
        ...
        "lesquels vous souhaiteriez vous exprimer ?":[1,2,3],
        }
}